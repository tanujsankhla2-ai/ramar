/**
 * Namastey Namastey � AI Chatbot Widget � js/chatbot.js
 * ---------------------------------------------
...
(() => {
    ...
    const SYSTEM_PROMPT = `You are "Namastey Concierge", a warm and professional AI beauty assistant for Namastey � Mumbai's premier luxury hair salon.
...
1. **Expert Hair Styling** � Precision cuts & luxury colour by senior Namastey stylists
2. **Hair Spa** � Deep conditioning and scalp treatments with Namastey's nourishing protocols
...
- **Modern Signature** � ?349+ (Expert Styling, Deep Conditioning, Full Artistry, Namastey Gift) ? Most popular
...
For unrelated questions, politely redirect: "As the Namastey Concierge, I'm best equipped to assist with hair, beauty, and our Mumbai salon services."`
    ...
    function buildWidget() {
        ...
        wrapper.setAttribute('aria-label', 'Namastey AI Chat Concierge');

        wrapper.innerHTML = `
            <!-- Toggle Bubble -->
            <button
                id="mrko-chat-toggle"
                aria-label="Open Namastey chat"
                aria-expanded="false"
                aria-controls="mrko-chat-window"
                title="Chat with Namastey Concierge"
            >
            ...
            <div
                ...
                role="dialog"
                aria-modal="true"
                aria-label="Namastey AI Chatbot"
                aria-hidden="true"
            >
                <!-- Header -->
                <div class="chat-header">
                    ...
                    <div class="chat-header-info">
                        <div class="chat-header-name">Namastey Concierge</div>
                ...
                <div class="chat-input-area">
                    <div class="chat-input-row">
                        <textarea
                            id="mrko-chat-input"
                            placeholder="Ask Namastey Concierge anything�"
                            rows="1"
                            maxlength="500"
                    ...
                    <p class="chat-footer-note" aria-hidden="true">? Powered by Namastey AI &bull; Gemini 2.0 Flash</p>
                </div>
            </div>
        `;
    ...
    function showTyping() {
        ...
        div.setAttribute('aria-label', 'Namastey Concierge is typing');
        div.innerHTML = `
            <div class="msg-avatar bot-avatar" aria-hidden="true"><i class="fas fa-spa"></i></div>
    ...
    async function sendMessage(text) {
        ...
        try {
            ...
            console.error('[Namastey Chatbot]', err);
        } finally {
            isTyping = false;
    ...
    function wireEvents() {
        ...
        if (waBtn) {
            waBtn.addEventListener('click', () => {
                window.open(`https://wa.me/${WHATSAPP_NUMBER}?text=Hello%20Namastey!%20I%27d%20like%20to%20inquire%20about%20a%20session.`, '_blank');
            });
        }
